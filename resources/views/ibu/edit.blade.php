            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" rows="2"
                              class="mt-1 w-full bg-gray-50 border rounded-xl px-4 py-3 focus:ring-2 focus:ring-pink-400 focus:border-pink-400 outline-none transition">{{ old('alamat', $ibu->alamat) }}</textarea>
                </div>
